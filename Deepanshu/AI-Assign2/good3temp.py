...
def get_score(board, board_stat, flag):
    ...
    if board_stat[0:3] == ['x', 'x', 'x' ] or board_stat[3:6] == ['x', 'x', 'x' ] or board_stat[6:9] == ['x', 'x', 'x' ] or board_stat[0::3] == ['x', 'x', 'x' ] or board_stat[3::6] == ['x', 'x', 'x' ] or board_stat[6::9] == ['x', 'x', 'x' ] or board_stat[0::4] == ['x', 'x', 'x' ] or board_stat[2:7:2] == ['x', 'x', 'x' ] :
        final_score += 10000

    elif board_stat[0:3] == ['o','o','o'] or board_stat[3:6] == ['o','o','o'] or board_stat[6:9] == ['o','o','o'] or board_stat[0::3] == ['o','o','o'] or board_stat[3::6] == ['o','o','o'] or board_stat[6::9] == ['o','o','o'] or board_stat[0::4] == ['o','o','o'] or board_stat[2:7:2] == ['o','o','o'] :
        final_score -= 10000
